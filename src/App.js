...
<div>
< Todo />
<button className='btn btn-primary mx-3 my-2 mr-auto ' type=' submit' onClick={handlerTest}>-</button>
...
const handleClick=()=>{
  ...
  return (
    ...
    <div className='container text-center my-2 image'>
      ...
      <input type="text" placeholder='city name' className='form-control' value={city} onChange={(e)=>{
